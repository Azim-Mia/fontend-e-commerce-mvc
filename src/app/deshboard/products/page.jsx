...
<div className="flex justify-between p-4">
  <div><Link href="/deshboard/product/create">Create Product</Link></div>
        ...
        <table className="w-full text-sm text-gray-700">
          ...
          <tbody>
            {dataProducts.map((product) => (
              ...
              <Link href={`/deshboard/product/update/${product.productId}`}>
                     <button className="px-3 py-1 bg-red-500 text-white rounded hover:bg-blue-600 transition">Edit</button>
                    </Link>
                 <Link href={`/deshboard/product/delete/${product.productId}`}>
